...
const Footer = () => {
  return (
    <footer className="bg-[#fff] py-[30px] h-[355px]">
      {/* Content Wrapper */}
      <div className="max-w-[1200px] mx-auto flex items-center justify-between h-[70%] px-4">
        {/* Address Section */}
        <div>
      ...
      <div className="border-t mt-8 pt-6 pl-[10px] text-gray-600 h-[10px]">
